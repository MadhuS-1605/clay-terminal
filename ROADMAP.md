...
Current state (v0.7.5): 4 color theme variants (dark, light, hc-black,
...
(`terminal/starship.toml`) and an Oh My Posh prompt theme
(`terminal/ohmyposh.json`), both downloadable and not bundled in the
